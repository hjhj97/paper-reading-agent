...
export default function SummaryDisplay({
  ...
  useEffect(() => {
    // Only auto-generate once when component mounts
    if (autoSummarize && !initialSummary && !summary && !isGenerating && !hasAutoGenerated) {
      setHasAutoGenerated(true);
      handleGenerateSummary();
    }
  }, [autoSummarize, initialSummary, summary, isGenerating, hasAutoGenerated]);
  ...
  }, [initialSummary, onSummaryGenerated]);
